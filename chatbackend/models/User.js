...
class User {
  constructor({_id, email, password, username, publicKey, encryptedPrivateKey, salt}){
    Object.assign(this, {_id, email, password, username, publicKey, encryptedPrivateKey, salt});
  }
