...
3. Buka terminal pada folder chatbackend DAN chatfrontend
4. Masukkan perintah ```npm run dev``` pada KEDUA TERMINAL TERSEBUT
5. Aplikasi web bisa diakses pada ```localhost:3000```
